  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="提现状态" prop="status">
        ...
        >
          <el-option
            v-for="dict in dict.type.cd_withdraw_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['cd:withdrawRecord:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['cd:withdrawRecord:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['cd:withdrawRecord:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['cd:withdrawRecord:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column label="提现状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.cd_withdraw_status"
...
} from '@/api/cd/withdrawRecord'

export default {
  name: 'WithdrawRecord',
  dicts: ['cd_withdraw_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
