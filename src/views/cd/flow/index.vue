  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="类型" prop="type">
        ...
        >
          <el-option
            v-for="dict in dict.type.cd_tokenflow_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    >
      ...
      <el-table-column label="类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.cd_tokenflow_type"
...
<script>
import { listFlow, getFlow, delFlow, addFlow, updateFlow } from '@/api/cd/flow'

export default {
  name: 'Flow',
  dicts: ['cd_tokenflow_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除代币流水编号为"' + ids + '"的数据项？')
        .then(function () {
          return delFlow(ids)
        })
        .then(() => {
